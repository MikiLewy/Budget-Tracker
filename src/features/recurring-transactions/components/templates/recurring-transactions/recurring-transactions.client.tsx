...
import { RecurringTransactionsActionSlotPayload } from '@/features/recurring-transactions/utils/get-recurring-transactions-table-columns';
import { getRecurringTransactionsTableColumns } from '@/features/recurring-transactions/utils/get-recurring-transactions-table-columns';
...
const ClientRecurringTransactions = () => {
  ...
  const columns = getRecurringTransactionsTableColumns(actionsSlot);
